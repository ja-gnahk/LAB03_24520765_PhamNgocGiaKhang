...
namespace Bai6
{
    public partial class Form1 : Form
    {
        ...
        private void btnEqual_Click(object sender, EventArgs e)
        {
            ...
            switch (operation)
            {
                ...
                case "*":
                    ...
                    break;
                case "/":
                    if (num2 == 0) tbDisplay.Text = "Khong the chia cho 0";
                    else
                    {
                        tbDisplay.Text = (num1 / num2).ToString();
                    }
        ...
        private void btnPlusMinus_Click(object sender, EventArgs e)
        {
            ...
            if (Decimal.TryParse(tbDisplay.Text, out currentValue))
            {
        ...
        private void btnSqrt_Click(object sender, EventArgs e)
        {
            ...
            if (Decimal.TryParse(tbDisplay.Text, out currentValue))
            {
                if (currentValue < 0)
                {
                    tbDisplay.Text = "Giá trị không hợp lệ";
                }
                else
                {
                    double doubleValue = (double)currentValue;
                    double sqrtResult = Math.Sqrt(doubleValue);

                    decimal decimalResult = (decimal)sqrtResult;
                    tbDisplay.Text = decimalResult.ToString();
        ...
        private void btnPercent_Click(object sender, EventArgs e)
        {
            ...
            if (Decimal.TryParse(tbDisplay.Text, out currentValue))
            {
                decimal percentResult = currentValue / 100;
                tbDisplay.Text = percentResult.ToString();

                // Cập nhật trạng thái giống như các phép toán tức thời khác (sqrt, 1/x)
                num1 = percentResult;
                isOperationPerformed = true;
                operation = "";
            }
        ...
        private void btnReciprocal_Click(object sender, EventArgs e)
        {
            ...
            if (Decimal.TryParse(tbDisplay.Text, out currentValue))
            {
                if (currentValue == 0)
                {
                    tbDisplay.Text = "Không thể chia cho 0";
                }
                else
                {
                    decimal reciprocalResult = 1 / currentValue;
                    tbDisplay.Text = reciprocalResult.ToString();
                    num1 = reciprocalResult;
                    isOperationPerformed = true;
                    operation = "";
                }
            }
